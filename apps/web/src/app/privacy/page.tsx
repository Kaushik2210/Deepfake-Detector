    ...
    <article className="prose max-w-none space-y-6">
      ...
      <section className="space-y-2">
        ...
        <ul className="list-disc space-y-1 pl-5 text-slate-700">
          <li>
            <strong>Automatic expiry.</strong> After {TTL_HOURS} hours the stored file
            is deleted. The report itself remains visible to you, along with the
            image&rsquo;s perceptual hash — a short irreversible fingerprint that cannot
            be used to reconstruct or view the image — so a repeat analysis of the same
            file can reuse the earlier result.
          </li>
          <li>
            <strong>Deleting it yourself.</strong> The delete control on any report
            removes everything immediately: the stored file, the report, and the
            perceptual hash. Nothing about that upload is retained.
          </li>
        </ul>
      </section>
