...
First real run with both on images (`reports/2026-09-02.md`, n=500/250/250, up from 400/200/200): spatial's numeric AUC edge over frequency on the final split (0.6694 vs 0.6175) turned out **not to be statistically significant** at that sample size — 95% CI on the difference was [-0.0412, 0.1535], which includes zero. Re-running at n=2000/1000/1000 (`reports/2026-09-07.md`) flips that verdict: the same comparison (spatial 0.6641 vs frequency 0.5752, a 0.0889 gap) is now **significant** — 95% CI [0.0397, 0.1365], p=0.0000. The weight-stability bootstrap agrees with the flip too: overlapping p10-p90 ranges at n=500 became non-overlapping ranges at n=2000 (spatial 0.556-0.686, frequency 0.314-0.444). The n=500 "not significant" result was not wrong — it was a correct read of a sample too small to detect a real but modest effect. Fusion weights moved from the earlier near-even split to a real 0.6238/0.3762 (spatial/frequency), tracking the larger run's measured cross-dataset AUCs directly. See `DECISIONS.md`, 2026-09-07.

The audio pair has shown a significant gap at every sample size tried, most recently at n=400/200/200 (`reports/audio-2026-09-07.md`): AASIST beats `audio_frequency` by 0.2089 AUC (0.9798 vs 0.7709) — 95% CI [0.1490, 0.2737], p≈0.0000 — and the weight-stability bootstrap agrees with no overlap between the two streams' weight ranges (audio p10-p90 0.694-0.804, audio_frequency 0.196-0.306). Unlike the image pair, audio's fusion-induced AUC penalty got *larger* at the bigger sample size (-0.0240, versus -0.0064 at n=120) rather than smaller — reported as measured, since there's no reason to expect that number to be stable across sample sizes any more than the image significance verdict was. See `DECISIONS.md`, 2026-09-07.
